  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div>
        ...
        {/* Espace pour compenser la card qui déborde */}
            ...
            {candidats.length > 0 ? (
              candidats.map((candidat, index) => (
                <BentoGridItem
                  key={index}
                  status={candidat.nom}
                  header={candidat.photo}
                  button="Voter"
                />
              ))
            ) : (
              <p className="text-gray-500">Aucun candidat pour cet événement</p>
            )}
          </BentoGrid>
        </div>
      </div>
