    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_user', models.CharField(choices=[('admin', 'Administrateur'), ('etudiant', 'Etudiant'), ('responsable', 'Responsable')], default='etudiant', max_length=50, verbose_name="Type d'utilisateur")),
